CREATE DATABASE airlines_booking_system;
USE airlines_booking_system;

-- creating profile table -- --------------------------------------------- 4 /
CREATE TABLE profile(
prfid VARCHAR(30) PRIMARY KEY NOT NULL,
...
INSERT INTO profile (prfid, loginid, prfName, prfdob, prfadd1, prfadd2, prfstate, prfpostcode, prfHPNo, prfPassportNo, prfemail, prfpwd)
VALUES ('811201101002', 'user1', 'Nur Aznah Ibrahim', '01-12-1981', 'No. 5, Taman Pasir Putih', 'Pasir Puteh', 'Kelantan', 16800, '011-8802142', 'C3341298', 'aznah@gmail.com', 'user001'),
...
-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- CREATING FLIGHT TABLE  ---------------------- 3
CREATE TABLE flight (
flightNo VARCHAR(15) PRIMARY KEY NOT NULL,
airportcode VARCHAR(10) NOT NULL,-- FOREIGN KEY REF TO AIRPORT TABLE
departFrom VARCHAR(30),
arrivalTo VARCHAR(30),
airplanecode VARCHAR(30) NOT NULL, -- FORIEGN KEY REF AIRPLANE TABLE
CONSTRAINT fk_flight_airportcode FOREIGN KEY(airportcode) REFERENCES airport(airportcode),
CONSTRAINT fk_flight_airplanecode FOREIGN KEY (airplanecode) REFERENCES airplane(airplanecode)
);
-- inserting values
...
-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- CREATING AIRPLANE TABLE --------------- 2
CREATE TABLE airplane(
airplanecode VARCHAR(30) PRIMARY KEY NOT NULL,
airlineName VARCHAR(50),
manufactured VARCHAR(50),
seatCapacity INT(30),
airportcode VARCHAR(10) NOT NULL,
CONSTRAINT fk_airplane_airportcode FOREIGN KEY(airportcode) REFERENCES airport (airportcode)
);
-- inserting values  ---------------- 2
...
-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- CREATE FLIGHT DETAILES TABLE ------------------------------- 5
CREATE TABLE flightDetails (
flightNo VARCHAR(15) NOT NULL, -- FOREIGN KEY REF FLIGHT TABLE 
...
CONSTRAINT fk_flightDetails_flightNo FOREIGN KEY(flightNo) REFERENCES flight(flightNo)
);
-- inserting values
...
bookingid VARCHAR(15) PRIMARY KEY NOT NULL,
prfid VARCHAR (30) NOT NULL, -- FOREIGN KEY REF PROFILE TABLE
flightNo VARCHAR(15) NOT NULL, -- FOREIGN KEY REF FLIGHT TABLE
bookingdate Date ,
departuredate DATE NOT NULL,
bookingstatus VARCHAR(30) ,
CONSTRAINT ck_booking_bookingstatus CHECK(bookingstatus IN ('Booking','Confirmed')),
CONSTRAINT fk_booking_prfid FOREIGN KEY(prfid) REFERENCES profile(prfid),
CONSTRAINT fk_booking_flightNo FOREIGN KEY(flightNo) REFERENCES flight(flightNo)
);
-- inserting values 
INSERT INTO booking (bookingid, prfid, flightNo, bookingdate,departuredate, bookingstatus)
VALUES ('PQ36TY', '811201101002', 'AK3522', '2016-07-07', '2016-08-13', 'Confirmed'),
       ...
       ('RS40TG2', '850918103698', 'AK6322', '2016-06-03', '2016-08-22', 'Confirmed'),
